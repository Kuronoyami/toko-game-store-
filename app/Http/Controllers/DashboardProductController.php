...
class DashboardProductController extends Controller
{
    ...
    public function store(/* Request */ProductRequest $request)
    {
        $data = $request->all();
        ...
        if ($request->hasFile('photo')) {
            $gallery['photos'] = $request->file('photo')->store('assets/product', 'public');
        }
    ...
    public function update(/* Request */ProductRequest $request, $id)
    {
        $data = $request->all();
